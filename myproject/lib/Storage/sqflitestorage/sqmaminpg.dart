...
import 'package:myproject/Storage/sqflitestorage/sqloperation.dart';
void main() {
...
class mainsqf extends StatefulWidget {
  const mainsqf({super.key});

  @override
  State<mainsqf> createState() => _mainsqfState();
}

class _mainsqfState extends State<mainsqf> {
  bool isLoading = true;
  ...
  void refreshData() async{
    ...
    setState(() {
      note_from_db = datas; // add the datas read from sqflite into empty state
      isLoading = false;
    });
  }
  @override
